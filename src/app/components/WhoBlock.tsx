  ...
  return (
    ...
    >
      <Image
        ...
        width={712}
        height={1280}
        className="block relative top-0 left-0 rounded-lg"
      />
      <div className="flex flex-col gap-4 p-8">
        ...
        <p className="text-neutral-500 text-lg">
          Айгерим Бекназарова - это профессиональный риелтор, которая занимается
          продажей апартаментов в Алматы. Она имеет огромный опыт в сдаче
          апартаментов в аренду на короткий срок и поможет вам найти идеальное
          жилье для вас и вашей семьи. Она работает по ИП и может помочь вам с
